...
const pages=[
  ...
  ['/construction-company-chennai',/construction company in Chennai/i],
  ['/house-construction-chennai',/house construction in Chennai/i],
  ['/individual-house-construction-chennai',/individual house construction/i],
  ...
  ['/construction-cost-coimbatore',/construction cost|Coimbatore/i],

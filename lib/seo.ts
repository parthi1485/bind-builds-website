...
export const organizationSchema={'@context':'https://schema.org','@type':'Organization','@id':site.url+'/#organization',name:site.name,url:site.url,logo:site.url+'/bind-builds-logo.svg',description:'Architect-led construction in Chennai, connecting design, engineering and site execution.',telephone:site.telephone,email:site.email,sameAs:[site.instagram],areaServed:{'@type':'City',name:'Chennai'},founder:{'@type':'Person',name:'Parthiban Moorthy'},contactPoint:{'@type':'ContactPoint',telephone:site.telephone,contactType:'project enquiries',availableLanguage:['English','Tamil']}};

...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'website', locale: 'en_IN', siteName: 'Bind Builds', title: 'Bind Builds — Your home. Thought through.', description: 'Architect-led home construction in Chennai. Design first. Build with clarity.' },
};

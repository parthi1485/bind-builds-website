...
export const metadata=pageMetadata("Chennai Home Construction FAQs","Answers to Chennai construction questions about costs, approvals, FSI, soil tests, waterproofing, paid design and the Bind Builds process.","/faq");

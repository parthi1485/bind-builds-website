...
const priorityZones:Array<[string,Array<[string,string]>]>=[
 ['Inner West Chennai',[['Valasaravakkam','/house-construction-valasaravakkam-chennai'],['Ramapuram','/house-construction-ramapuram-chennai'],['Virugambakkam','/house-construction-west-chennai#virugambakkam'],['Porur','/house-construction-porur-chennai'],['Vadapalani','/house-construction-west-chennai#vadapalani'],['Saligramam','/house-construction-west-chennai#saligramam']]],

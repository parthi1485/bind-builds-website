...
const title='House Construction in Anna Nagar, Padi & Koyambedu | Bind Builds';
const description='Architect-led house construction for Anna Nagar, Padi and Koyambedu Chennai, including new homes, demolition and rebuild projects, coordinated design and site execution.';
...
export default function AnnaNagar(){
 ...
 return <Page kicker="ANNA NAGAR + PADI + KOYAMBEDU" title="Build carefully in an established neighbourhood.">
  ...
  <StructuredData data={[breadcrumbSchema('House construction in Anna Nagar, Padi and Koyambedu',path),serviceSchema]}/>
 </Page>;
}

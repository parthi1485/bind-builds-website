...
const localityIntent=[
 ...
 {id:'virugambakkam',name:'House construction in Virugambakkam',eyebrow:'Virugambakkam',copy:'Compact plots, adjoining homes, car parking and rebuild decisions can strongly shape the plan. We coordinate architecture, structure and services before execution assumptions are locked.',link:'/house-construction-virugambakkam-vadapalani-saligramam',linkLabel:'Read the inner-West cluster guide →'},
 ...
 {id:'vadapalani',name:'House construction in Vadapalani',eyebrow:'Vadapalani',copy:'For established urban plots, demolition sequence, neighbour interfaces, storage space, parking and movement of construction materials deserve early planning alongside the family brief.',link:'/house-construction-virugambakkam-vadapalani-saligramam',linkLabel:'Read the inner-West cluster guide →'},
 {id:'saligramam',name:'House construction in Saligramam',eyebrow:'Saligramam',copy:'Plot efficiency matters on many inner-city sites. We work through setbacks, circulation, parking, light, ventilation, neighbouring buildings and build access as connected design decisions.',link:'/house-construction-virugambakkam-vadapalani-saligramam',linkLabel:'Read the inner-West cluster guide →'},
 {id:'gerugambakkam',name:'House construction in Gerugambakkam',eyebrow:'Gerugambakkam',copy:'For growing residential streets, road width, utilities, site levels, drainage, soil information and the applicable approval route should be checked before the structural and external-work scope is finalised.',link:'/house-construction-gerugambakkam-kolapakkam-chennai',linkLabel:'Read the Gerugambakkam / Kolapakkam guide →'},
 {id:'mangadu',name:'House construction in Mangadu',eyebrow:'Mangadu',copy:'We assess the exact street and plot rather than assuming one standard solution across the locality. Access, site levels, water and drainage planning, utilities and future floor requirements are reviewed early.',link:'/house-construction-mangadu-kundrathur-chennai',linkLabel:'Read the Mangadu / Kundrathur guide →'},
 {id:'kundrathur',name:'House construction in Kundrathur',eyebrow:'Kundrathur',copy:'Residential plots can differ significantly in road access and surrounding development. We connect the family programme with soil investigation, engineering, approvals and site logistics before construction starts.',link:'/house-construction-mangadu-kundrathur-chennai',linkLabel:'Read the Mangadu / Kundrathur guide →'},
 {id:'kolapakkam',name:'House construction in Kolapakkam',eyebrow:'Kolapakkam',copy:'For independent homes, we look at plot orientation, street width, levels, parking, outdoor space and services together so the architecture and execution plan are not developed separately.',link:'/house-construction-gerugambakkam-kolapakkam-chennai',linkLabel:'Read the Gerugambakkam / Kolapakkam guide →'},
 {id:'maduravoyal',name:'House construction in Maduravoyal',eyebrow:'Maduravoyal',copy:'Mixed street conditions make construction access and storage important. We also review multi-floor family use, parking, demolition where relevant, external works and the written specification before pricing.',link:'/house-construction-maduravoyal-vanagaram-kattupakkam',linkLabel:'Read the Maduravoyal / Vanagaram / Kattupakkam guide →'},
 {id:'vanagaram',name:'House construction in Vanagaram',eyebrow:'Vanagaram',copy:'For new residential projects we review access, levels, drainage, utility connections, future expansion and the exact site context before confirming the building and external-work scope.',link:'/house-construction-maduravoyal-vanagaram-kattupakkam',linkLabel:'Read the Maduravoyal / Vanagaram / Kattupakkam guide →'},
 {id:'kattupakkam',name:'House construction in Kattupakkam',eyebrow:'Kattupakkam',copy:'The first decisions are practical: road width, plot levels, utility availability, family requirements, parking and expected floors. Those inputs shape design, engineering and budget together.',link:'/house-construction-maduravoyal-vanagaram-kattupakkam',linkLabel:'Read the Maduravoyal / Vanagaram / Kattupakkam guide →'},

...
export default function Home() {
  return <><Nav /><main id="main-content">
    ...
    <section className="section budgetSection">
      ...
      <p className="smallPrint">*Indicative base construction rates. Final pricing depends on design, area, site conditions and scope. Confirm taxes, approvals, external works and all exclusions in your proposal.</p><Link className="textLink" href="/cost-calculator">Calculate your construction budget ↗</Link>
    </section>
